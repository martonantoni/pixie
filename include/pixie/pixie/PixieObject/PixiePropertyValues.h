...
struct cPixieObject::cPropertyValues
{
	...
	cPropertyValues(const cRect &Rect): mPropertyCount(4) { mProperties[0]=Rect.mLeft; mProperties[1]=Rect.mTop; mProperties[2]=Rect.mWidth; mProperties[3]=Rect.mHeight; }

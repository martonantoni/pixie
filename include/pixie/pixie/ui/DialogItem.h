...
class cDialogItems
{
	...
	void AddPushButton(cPixieWindow &Window, std::shared_ptr<cConfig> config);
	void AddTextField(cPixieWindow &Window, std::shared_ptr<cConfig> config);
	void AddEditField(cPixieWindow &Window, std::shared_ptr<cConfig> config);
public:
	void Init(cPixieWindow &Window, std::shared_ptr<cConfig> Config);

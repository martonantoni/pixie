namespace std
{
	template<typename C, typename V> auto find(C &Container, const V &Value)
	{
		return std::find(begin(Container), end(Container), Value);
	}

	template<typename C, typename P> auto find_if(C &Container, P Pred)
	{
		return std::find_if(begin(Container), end(Container), Pred);
	}

	template<typename C, typename P> auto find_if_not(C &Container, P Pred)
	{
		return std::find_if_not(begin(Container), end(Container), Pred);
	}

	template<typename C, typename P> auto sort(C &Container, P Pred)
	{
		return std::sort(begin(Container), end(Container), Pred);
	}

	template<typename C, typename P> auto stable_sort(C &Container, P Pred)
	{
		return std::stable_sort(begin(Container), end(Container), Pred);
	}

	template<typename C, typename P> auto min_element(C &Container, P Pred)
	{
		return std::min_element(begin(Container), end(Container), Pred);
	}

	template<typename C, typename P> auto max_element(C &Container, P Pred)
	{
		return std::max_element(begin(Container), end(Container), Pred);
	}

	template<typename C, typename P> auto all_of(C &Container, P Pred)
	{
		return std::all_of(begin(Container), end(Container), Pred);
	}

	template<typename C, typename P> auto any_of(C &Container, P Pred)
	{
		return std::any_of(begin(Container), end(Container), Pred);
	}

	template<typename C, typename P> auto none_of(C &Container, P Pred)
	{
		return std::none_of(begin(Container), end(Container), Pred);
	}

	template<typename C, typename P> auto count_if(const C &Container, P Pred)
	{
		return std::count_if(cbegin(Container), cend(Container), Pred);
	}

	template<typename C, typename V, typename P> auto lower_bound(C &Container, const V &Val, P Pred)
	{
		return std::lower_bound(begin(Container), end(Container), Val, Pred);
	}

	template<typename C, typename V> auto lower_bound(C &Container, const V &Val)
	{
		return std::lower_bound(begin(Container), end(Container), Val);
	}

	template<typename C, typename V, typename P> auto upper_bound(C &Container, const V &Val, P Pred)
	{
		return std::upper_bound(begin(Container), end(Container), Val, Pred);
	}

	template<typename C, typename V> auto upper_bound(C &Container, const V &Val)
	{
	...
	{
		return std::remove_if(begin(Container), end(Container), Pred);
	}

	template<typename C, typename P> auto generate(C &Container, P Pred)
	{
		return std::generate(begin(Container), end(Container), Pred);
	}

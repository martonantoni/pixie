...
void cListBox::cInitData::setConfig(tIntrusivePtr<cConfig2> config)	
{
	...
	mItemHighlightEnabled = config->get<bool>("highlight_enabled", true);
	mItemSelectEnabled = config->get<bool>("select_enabled", true);
}
